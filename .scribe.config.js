module.exports = {
   ...
   */
  baseUrl: "https://debtmonitor.herokuapp.com/api",

  /*
   * The HTML <title> for the generated documentation, and the name of the generated Postman collection and OpenAPI spec.
   */
  title: "Sanwo Documentation",
  description:
    "Sanwo is a debt management system for recording of debts owed to you and by you. Sanwo automatically calculates your debit and credit balance, prepares your record summary and alert you via your email daily on due debts (if any)",
   ...
   */
  logo: "./public/images/logo192.png",
   ...
   */
  exampleLanguages: ["javascript", "bash"],
   ...
   */
  introText: `Welcome to Sanwo API documentation!
